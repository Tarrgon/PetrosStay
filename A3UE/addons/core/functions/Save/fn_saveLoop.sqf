...
savingServer = true;
Info("Starting persistent save (with PetrosStay)");
...
// PetrosStay - Save Petros location
private _petrosPosition = getPosATL petros;
InfoArray("[PetrosStay] Saving Petros' position at:", _petrosPosition);
["petrosStay_petrosPosition", _petrosPosition] call A3A_fnc_setStatVariable;
